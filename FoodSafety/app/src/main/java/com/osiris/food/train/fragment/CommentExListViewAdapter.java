...
public class CommentExListViewAdapter extends BaseExpandableListAdapter implements View.OnClickListener {
    ...
    private void createCommentEditDialog() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                SubCommentItem subCommentItem = new SubCommentItem(R.drawable.bg_login_icon, "评论用户", commentContent);
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        commentViewHolder.priseBtn.setTag(groupPosition);
        commentViewHolder.priseBtn.setOnClickListener(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.commentListViewItem_prise_btn:
                mCurrentGroupPosition = (Integer) v.getTag();
                LogUtils.d("zkf prise");
                //点赞
...
//                ((EditText) mCommentEditDialog.findViewById(R.id.dialogSubComment_commentContentInput_edt)).setText("");
    ...
    class CommentViewHolder {
        ...
        CommentViewHolder(View parent) {
            ...
            priseBtn = (TextView) parent.findViewById(R.id.commentListViewItem_prise_btn);
        }
    }
